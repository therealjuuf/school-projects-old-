...
% Last Modified by GUIDE v2.5 17-Jan-2019 20:53:08
...
global rotato;
global currentImage;
currentImage=imrotate(currentImage,rotato);
...
% If the metricdata field is present and the view flag is false, it means
% we are we are just re-initializing a GUI by calling it from the cmd line
% while it is up. So, bail out as we dont want to view the data.
...
%
cla(handles.prev_img);
axes(handles.prev_img);
