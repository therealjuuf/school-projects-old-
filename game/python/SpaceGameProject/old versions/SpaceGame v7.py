...
class _GameWorld:
    ...
    def PlayerDeath(self):
        ...
        for a in range(0,len(self.CurrentProcessor.ScoreBoardPoints)-1,1):
            if(self.CurrentProcessor.Player.score>int(self.CurrentProcessor.ScoreBoardPoints[a-1])):
                #print (len(self.CurrentProcessor.ScoreBoardPoints))
                self.CurrentProcessor.ScoreBoardPoints[a]=self.CurrentProcessor.Player.score
                self.CurrentProcessor.ScoreBoardNames[a]="xxa"
